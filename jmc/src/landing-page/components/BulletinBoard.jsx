  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
      ...
      <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
        ...
        <span className="text-[10px] font-semibold text-[#FF6600] bg-orange-50 border border-orange-200 px-2 py-0.5 rounded-full uppercase tracking-wide">
          Live
        </span>
      </div>
        ...
        {loading ? (
          ...
          <div className="animate-slideUp">
            {items.map((item, idx) => (
              <div
                key={idx}
                className="flex items-start gap-0 border-b border-gray-100 last:border-0 hover:bg-[#f8fafc] transition-colors"
              >
