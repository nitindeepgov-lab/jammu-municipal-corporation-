    ...
    <section className="relative overflow-hidden bg-white border-t border-gray-100">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(rgba(0,51,102,0.4) 1px, transparent 1px)",
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 min-w-0 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2.5 mb-6 px-4 py-1.5 rounded-full border border-[#003366]/10 bg-[#003366]/[0.03]">
              ...
              />
              <span className="text-[11px] font-bold uppercase tracking-[0.15em] text-[#FF6600]">
                Official Mobile App
              </span>
            </div>
            ...
            <h2 className="text-4xl sm:text-5xl font-extrabold leading-[1.1] mb-4">
              ...
              <span
                style={{
                  background:
                    "linear-gradient(135deg, #FF6600, #ff8533, #FF6600)",
            ...
            <p className="text-gray-500 text-base sm:text-lg mb-8 max-w-md mx-auto lg:mx-0 leading-relaxed">
              Access all municipal services, track grievances, and stay updated
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
              {features.map((f, i) => (
                <div
                  ...
                  style={
                    activeFeature === i
                      ? { boxShadow: "0 4px 20px rgba(255,102,0,0.08)" }
                      : {}
                  }
                >
                  <div
                  ...
                  <div className="min-w-0">
                    <p
                      className={`text-sm font-semibold transition-colors duration-300 ${activeFeature === i ? "text-[#003366]" : "text-gray-700"}`}
                    >
                      {f.title}
                    </p>
          ...
          <div
            className="hidden lg:flex flex-shrink-0 w-[480px] items-center justify-center relative"
            style={{ minHeight: "520px" }}
          >
            {/* Ambient glow rings */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div
                className="w-[420px] h-[420px] rounded-full border border-[#003366]/[0.04]"
                style={{ animation: "pulse-ring 6s ease-in-out infinite" }}
              />
            </div>
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div
                className="w-[320px] h-[320px] rounded-full border border-[#FF6600]/[0.06]"
            ...
            <div className="phone-primary relative z-20">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(145deg, #0f2033 0%, #0a1628 100%)",
                  border: "3px solid rgba(0,0,0,0.1)",
                  boxShadow:
                    "0 30px 60px rgba(0,0,0,0.18), 0 0 0 1px rgba(0,0,0,0.05), 0 0 40px rgba(0,51,102,0.08)",
                }}
              >
                {/* Screen shine */}
                ...
                <div className="relative z-20 flex justify-center mt-0">
                  <div
                    className="w-[90px] h-[25px] bg-black rounded-full"
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      >
                        ...
                        />
                        <span className="text-white/40 text-[10px] font-medium flex-1">
                          {item}
                        </span>
                        <svg
                ...
                {/* Bottom nav bar */}
                <div
                  className="absolute bottom-0 left-0 right-0 z-20 px-5 pb-4 pt-3"
                  style={{
                    background:
                      "linear-gradient(transparent, rgba(10,22,40,0.95))",
                  }}
                >
                  <div className="flex items-center justify-between px-2">
                    {["Home", "Services", "Track", "Profile"].map((item, i) => (
                      <div key={i} className="flex flex-col items-center gap-1">
                        <div
                          className={`w-5 h-5 rounded-md ${i === 0 ? "bg-[#FF6600]" : "bg-white/10"}`}
                        />
                        <span
                          className={`text-[8px] font-medium ${i === 0 ? "text-[#FF6600]" : "text-white/30"}`}
                        >
                          {item}
                        </span>
                      </div>
            ...
            <div
              className="phone-secondary absolute z-10"
              ...
              >
                <div className="relative z-10 px-4 pt-14">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {["Water Bill", "Certificates", "Building", "RTI"].map(
                      (item, i) => (
                        <div
                          key={i}
                          className="h-16 rounded-xl flex flex-col items-center justify-center gap-1.5"
                        ...
                        >
                          ...
                          <span className="text-white/35 text-[9px] font-medium">
                            {item}
                          </span>
                        </div>
                      ),
            ...
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 8px 24px rgba(0,0,0,0.1), 0 2px 8px rgba(0,0,0,0.04)",
              }}
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-[10px] text-[#003366] font-semibold">
                    Tax Paid
                  </p>
              ...
              <div className="flex items-center gap-2">
                <div className="flex gap-[1px]">
                  {[1, 2, 3, 4, 5].map((n) => (
                    <svg
                      key={n}
                      className={`w-3 h-3 ${n <= 4 ? "text-yellow-400" : "text-gray-200"}`}
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
