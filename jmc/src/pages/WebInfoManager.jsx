      ...
      <div className="space-y-5">
            ...
            <table className="w-full table-fixed text-xs sm:text-sm">
              <thead>
                <tr className="bg-gray-50">
                  <th className="px-2.5 sm:px-4 py-2.5 sm:py-3 text-left text-[11px] font-semibold text-gray-500 uppercase tracking-wide whitespace-normal break-words">
                    Name
                  </th>
                  <th className="px-2.5 sm:px-4 py-2.5 sm:py-3 text-left text-[11px] font-semibold text-gray-500 uppercase tracking-wide whitespace-normal break-words">
                    Designation
              ...
              <tbody>
                <tr className="border-t border-gray-100 hover:bg-gray-50">
                  <td className="px-2.5 sm:px-4 py-2.5 sm:py-3 font-medium text-gray-800 align-top break-words">
                    Shri Ankush Kapoor
                  </td>
                  ...
                  <td className="px-2.5 sm:px-4 py-2.5 sm:py-3 text-gray-700 align-top break-all">
                    <a
                      href="mailto:jmc.jammu@gmail.com"
                      className="hover:text-[#003366] transition-colors break-all"
                    >
                      jmc.jammu@gmail.com
                    </a>
                  </td>
            ...
            <table className="w-full table-fixed text-xs sm:text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  ...
                  {
                    dept: "IT Cell / Web Manager",
                    phone: "0191-2478933",
                    email: "jmc.jammu@gmail.com",
                  },
                  {
                    dept: "Toll Free Helpline",
                    phone: "1800-180-7207",
                    email: "—",
                  },
                ].map(({ dept, phone, email }) => (
                  <tr key={dept} className="hover:bg-gray-50">
                    <td className="px-2.5 sm:px-4 py-2.5 sm:py-3 font-medium text-gray-700 align-top break-words">
                      {dept}
                    </td>
                    <td className="px-2.5 sm:px-4 py-2.5 sm:py-3 text-gray-600 align-top break-all">
                      <a
        ...
        <div className="bg-blue-50 border border-blue-100 rounded p-4 flex gap-3 items-start text-sm text-gray-600">
          ...
          <p className="leading-relaxed">
            This website is designed, developed&nbsp;&amp;&nbsp;maintained by
            the IT Cell of Jammu Municipal Corporation. For content-related
            queries, please contact the Web Information Manager at the address
            above.
          </p>
        </div>
      </div>
