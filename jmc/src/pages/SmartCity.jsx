...
export default function SmartCity() {
  return (
    <SubpageTemplate
      title="Smart City Mission — Jammu"
      breadcrumb={[{ name: "Smart City" }]}
    >
      <div className="space-y-5">
        ...
        <div className="bg-white rounded shadow-sm p-6">
          ...
          <p className="text-gray-700 text-sm leading-relaxed mb-4">
            Jammu was selected under the Smart Cities Mission by the Government
            of India. The Mission aims to promote cities that provide core
            infrastructure, a clean and sustainable environment, and give a
            decent quality of life to their citizens through smart solutions.
          </p>
          <p className="text-gray-700 text-sm leading-relaxed mb-4">
            The Smart City proposal for Jammu focuses on Area-Based Development
            (ABD) of the core city area along with pan-city smart solutions
            including intelligent traffic management, smart parking, and a
            ...
            {projects.map((project, idx) => (
              ...
              >
                <div className="flex items-start justify-between gap-3 mb-3">
                  ...
                  <span
                    className={`text-xs px-3 py-1 rounded-full font-medium flex-shrink-0 ${project.statusColor}`}
                  >
                    {project.status}
                  </span>
                </div>
