...
/**
 * Grants public find/findOne permissions for Governing Body Members (Ministers).
 * Usage: node scripts/grant-ministers-permissions.js
 */
...
async function main() {
  ...
  const actions = [
    'api::minister.minister.find',
    'api::minister.minister.findOne',
  ];
  ...
  console.log('Minister public permissions are ready.');
  process.exit(0);
}
